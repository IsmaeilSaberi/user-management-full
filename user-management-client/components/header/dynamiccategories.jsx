      ...
      {data.length < 1 ? (
        ...
        data.map((da, i) => (
          <li
            ...
            className="bg-[#b17d23] cursor-pointer text-white hover:text-[#b12357] border-purple-300 border-[0.1rem] h-9 rounded px-1 flex justify-center items-center transition-all duration-200 hover:bg-[864AF9]"
          >
            {da.title}
            <DynamicDropdown
              index={i}
