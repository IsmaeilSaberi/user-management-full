...
const Header = () => {
  ...
  return (
    <header className="container mx-auto md:border-2 my-2 h-[12vh] md:h-[26vh] relative z-50 text-[#332941]">
      <div
        className={
          menuIsOpen == -1
      ...
      >
        <div className="flex flex-col rounded-full-sm p-2 md:flex-row justify-start items-center md:items-start gap-8 w-full">
          <div
          ...
          >
            <Link
              href={"/"}
              onClick={() => setMenuIsOpen(-1)}
              className="logo w-52 z-30 bg-white flex flex-col gap-2 p-2 rounded-full cursor-pointer transition-all duration-150 hover:shadow-[0px_1px_10px_rgba(0,0,0,0.5)]"
            >
          ...
          <div className="flex flex-col gap-2 justify-center">
            <nav className="flex flex-col md:flex-row justify-between items-center w-full">
              <ul className="flex text-sm flex-col flex-wrap md:flex-row justify-between gap-4 md:gap-2 items-center">
                <li className="rounded-full  w-52 z-40 p-1 border-purple-300 border-[0.1rem] bg-[#332941] text-white hover:text-[#b12357]  text-center hover:shadow-gray-300 transition-all duration-200 hover:shadow-xl">
                  <HeaderUser
                    setMenuIsOpen={setMenuIsOpen}
                    displayName={displayName}
                  />
                </li>
                <li className="rounded-full  w-36 z-40 p-1 border-purple-300 border-[0.1rem] bg-[#332941] text-white hover:text-[#b12357]  text-center hover:shadow-gray-300 transition-all duration-200 hover:shadow-xl">
                  <Link
                    className="border-purple-300 border-[0.1rem] h-9 rounded-full px-1 flex justify-center items-center transition-all duration-200 hover:bg-[864AF9] "
                    href={"/"}
                    onClick={() => setMenuIsOpen(-1)}
                  >
                    خانه
