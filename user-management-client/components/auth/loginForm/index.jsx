  ...
  return (
    <section className="container mx-auto flex justify-center items-center">
      <form
        ...
        className="flex flex-col border-2 border-[#332941] gap-6 m-4 md:m-8 w-full md:w-[30rem] bg-[#F5F5DC] rounded p-2 md:p-8"
      >
        <div className="flex justify-center items-center gap-6 ">
          <h1 className="text-base md:text-xl text-center text-[#332941] font-bold">
            ورود به حساب
          </h1>
          <Link
            className="bg-[#FFB000] rounded text-[#332941] px-2 py-1 transition-all duration-200 hover:bg-blue-700 hover:text-white"
            href={"/register"}
          >
            ثبت نام در سایت
          </Link>
        ...
        <button
          type="submit"
          className="bg-[#332941] rounded p-2 text-white w-full transitioln-all duration-200 hover:bg-[#FFB000]"
        >
          ورود به حساب کاربری
        </button>
      </form>
